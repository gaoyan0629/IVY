...
"+y
copy thcomment e current selection to a clipboard where other programs can use it
...
<c-x> <TAB> 
completes using the word in the file

<c-x><c-k>
completes using dictionary
<c-v>
